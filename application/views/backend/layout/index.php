...
<html lang="en">
  <head>
    ...
    <link href="template/fontend/css/jumbotron.css" rel="stylesheet">
  ...
  <body style="background: url(template/fontend/image/bg_main_index.jpg) no-repeat;">

    <nav class="navbar navbar-a navbar-inverse">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href=".">Chatwork</a>
        </div>
